...
def main():
    ...
    parser.add_argument('--state-path', type=str, default="/opt/train/Experiment_3/states/",
                        help="The directory to pull and store states from")
    parser.add_argument('--session-path', type=str, default="/opt/train/Experiment_3/session/",

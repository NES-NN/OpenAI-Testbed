...
def evolve(config, num_cores):
    ...
    for sp in [530, 1320, 1600, 2204, 2800]:
        ...
        pop.add_reporter(neat.Checkpointer(100, None, CHECKPOINTS_DIR + "neat-checkpoint-" + str(STUCK_POINT) + "-"))
...
def main():
    ...
    parser.add_argument('--num-cores', type=int, default=6,
                        help="The number of cores on your computer for parallel execution")
    parser.add_argument('--state-path', type=str, default="/opt/train/Experiment_4b/states/",
                        help="The directory to pull and store states from")
    parser.add_argument('--session-path', type=str, default="/opt/train/Experiment_4b/session/",
